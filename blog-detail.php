...
<!-- Mirrored from finelayers.net/html/soccer/soccer-ltr/blog-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Jan 2018 12:13:18 GMT -->
<head>
						...
						<div class="blog-detail-holder">
							<div class="author-header">
								...
								<div class="aurhor-img-name pull-left">
									...
									<strong>by <i class="red-color"><?php $hello->puser();  ?></i></strong>
									<span>on <?php $hello->ptime();  ?> </span>
								</div>
							...
							<div class="blog-detail">
								<figure>
									...
									$info = $_GET['v']; 
$view = $con->prepare("SELECT * FROM soccer_posts WHERE id = '$info' LIMIT 1");
...
$view->execute();
    while ($data = $view->fetch()) {
      ...
      $u = $data['username'];
      $GLOBALS['user'] = $GLOBALS['u'];
      //echo "$img";
  }
									echo"
									<img src='profile/featured_image/".$img." ' alt=''>
									";
									?>
								</figure>
								<article>
              ...
              if ($row_Recordset1) {
	                   ...
	                   $trim = substr("$r",0,200)." "."...";
                        ...
                        $trim = $r;
                         ...
                         $img = "profile/featured_image/".$row_Recordset1['featured_image']."";
                         $title = $row_Recordset1['title'];
                         $url =  "blog-detail.php?v=".$row_Recordset1['id']."";
         ...
         <div class='row'>
              ...
              <div class='large-post-img'>
									...
									<div class='large-post-detail style-3'>
										<span class='red-color'>".$title."</span>
										<h2><a href='".$url."'>Man United reunion for Ibrahimovic, Mourinho Klopp plots</a></h2>
									</div>
									<!-- Post Detail -->
						...
						<!-- Leave a Reply  -->
                           ...
                           if (isset($_SESSION['username'])) {
							...
							<form class="row" method="POST">
								<div class="col-sm-4"> 
									<div class="form-group">
								    	<input type="text"  name="name" class="form-control" value="'.$u.'" readonly>
								   	...
								   	<div class="form-group">
								    	<input type="text" name="phone" class="form-control" placeholder="Phone" >
								   		...
								   		<div class="form-group">
								   	 <input type="hidden" class="form-control" placeholder="PHONE" name="t" value="'.$t.'">
								   	</div>
								   	<button type="submit" name="mgr" class="btn red-btn full-width" >Send Comments</button>
								</div>
								<div class="col-sm-8">
									<div class="form-group">
										<textarea class="form-control style-d" rows="11" id="comment" placeholder="Write Comments here..." name="message"></textarea>
                           	...
                           	$mgr = "<center><b style='color:red;'>please login to comment on the post</b></center>";
                           	$b = "<center><a href='login.php'><button class='btn btn-warning btn-small'>Login</button></a></center>";
...
<!-- Mirrored from finelayers.net/html/soccer/soccer-ltr/blog-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Jan 2018 12:13:22 GMT -->
</html>